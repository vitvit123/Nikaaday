      ...
      {candlesBlownOut && (
        ...
        >
          ...
          <Link to="/present" className="flex justify-center items-center">
            <p id="nextpresent" className="absolute top-[30rem] mb-[10rem] xs:top-[36rem] s:top-[40rem] px-7 py-3 bg-customBlue text-white rounded-full hover:bg-blue-600 font-medium text-base text-center ">
              Next Page
            </p>
          </Link>
        </motion.div>
